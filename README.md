...
## 주요 프로젝트
### korail 차량 정비 메타버스
- 프로젝트 소개  : 철도 차량 정비 메타버스 플랫폼 개발
- 사용기술       : 아키텍처 설계 | WebSocket 실시간 | API 설계 | UGUI | Addressable
- 영상 링크      : https://youtu.be/gUBaszRsmwc

## L사 이차전지 공정 디지털 트윈
- 프로젝트 소개  : 공정 가상 트레이닝 어플리케이션 
- 사용기술       : UGUI | Animator | WebSocket 실시간
- 영상 링크      : https://youtu.be/5bmZYD5HqdM
...
## Dragon Ace Casino
- 프로젝트 소개  : 소셜 카지노 게임
- 사용기술       : Xcode iSO빌드 | Android 빌드 | 안티치트
- 영상 링크      : https://youtu.be/Fti04bzSnMw
